        ...
        items = items + `
                <tr>
                    ...
                    <td class="text-center">${i.paymentOption.name}</td>
                     <td class="tright">${numberFormat(i.amount)}</td>
                ...
                <div class="row">
                        ...
                        <div class="logo col-5" style="padding-bottom:0px;" > 
                            ${
                                ...
                                :  setting.title.en.status && setting.title.kh.status ?   ` <h2 style="text-align: left;margin-top: 20px;width: 100%;line-height:32px;">${setting.title.kh.name} <br/> <span>${setting.title.en.name}</span></h2>`
                ...
                <div class="item" style="flex: 1;">
                    <table class="items_tb_border" style="width:100%">
                        <body>
                            ...
                            ${ data ? rederListReceipt(data.itemLine,check_panalty,check_discount): 
                            `
                                <tr>
                                    <td></td>
                                    <td></td>
