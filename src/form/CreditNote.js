...
function billingAddress(address) {
    ...
    address.forEach((i, index) => {
        address_bill = index == 0 ? address_bill + i.line1 : address_bill + ", " + i.line1
    })
    return address_bill;
}
exports.CreditNote = (data, setting, is_print) => {
                        ...
                        <table>
                            <body>
                                ...
                                <tr style="color: ${setting.color.color};">
                                    ...
                                    <td>:</td>
                                    <td>${data ? billingAddress(data.customer.billingAddress) : ''}</td>
                                </tr>
                                <tr style="color: ${setting.color.color};">
                    ...
                    <table class="items_bottom" style="margin-top:0px !important;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="tright">${data ? currency_d + data.itemLineExchangeAmount + currency_r : ''}</td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
...
exports.print = (data, form_id, setting) => {
    ...
    let is_print = true;
    var contents = this.CreditNote(data, setting, is_print);
