         ...
         <div class="form_setting">
                ...
                <div style="margin-bottom: 8px;">
                  ${
                    ...
                    :  setting.title.en.status && setting.title.kh.status ?   ` <h2 style="text-align: center;margin-top: 20px;width: 100%;line-height:32px;">${setting.title.kh.name} <br/> <span>${setting.title.en.name}</span></h2>`
                    ...
                    <table class="items_tb_border">
                        <body>
                            <tr>
                                ...
                                <td style="widht:120px;">${data ? data.journal.number : 'JV00000009'}</td>
                            ...
                            <tr>
                                ...
                                <td class="text-bold">${setting.language=='English' ? 'Location': setting.language=='Khmer' ?  'ទីតាំង' : 'ទីតាំង Location'}</td>
        ...
        ${Header(setting.page,is_print)}
         <div class="form_setting">
                ...
                <div style="">
                    ...
                    setting.title.en.status && !setting.title.kh.status ? 
                        `<h2 style="text-align: center;margin-top: 20px;width: 100%;line-height:32px;">${setting.title.en.name}</h2>`
                    :  setting.title.en.status && setting.title.kh.status ?   ` <h2 style="text-align: center;margin-top: 20px;width: 100%;line-height:32px;">${setting.title.kh.name} <br/> <span style="">${setting.title.en.name}</span></h2>`
                    :  `<h2 style="text-align: center;margin-top: 20px;width: 100%;line-height:32px;">${setting.title.kh.name}</h2>`
                    }
                </div>
                <div style="margin-bottom:14px" >
