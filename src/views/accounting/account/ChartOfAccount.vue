        ...
        methods: {
            ...
            async bindData() {
                ...
                this.coa.tbdetails.forEach(value => {
                    ...
                    if(account.is_secondary === 0){
                        /* Child Id Base On Number */
                        childIds.push(account.number);
                        ...
                        if(thisAccountParentId !== ""){/* Child Level Base On Number */
                            if(!g[account.number]){
