      ...
      <v-card color="white" class="pa-3 no_border" elevation="0">
        ...
        <v-row class="mt-0">
          <v-col sm="3" cols="12" class="pt-0">
            <v-card outlined dense class="pa-3 no_border rounded-4 white--text" color="secondary" height="60px"
          ...
          <v-col sm="3" cols="12" class="pt-0">
            <v-card outlined dense color="third" class="pa-3 rounded-4 no_border white--text" height="60px"
              ...
              <h3 class="font_20 mt-0 flex-1 text-right white--text">{{ numberFormat(totalSaleLead) }}</h3>
            </v-card>
          </v-col>
          <v-col sm="3" cols="12" class="pt-0">
            <v-card outlined dense color="third" class="pa-3 rounded-4 no_border white--text" height="60px"
              ...
              <h3 class="font_20 mt-0 flex-1 text-right white--text">{{ numberFormat(totalSaleQuote) }}</h3>
            </v-card>
          </v-col>
          <v-col sm="3" cols="12" class="pt-0">
            <v-card outlined dense class="pa-3 no_border black--text" color="grayBg" height="60px"
                    @click="searchTransaction('Sale Order')">
              <h3 class="text-left flex-1 font_12 text-uppercase">{{ $t('open_sale_order') }}</h3>
              <h3 class="font_20 mt-0 flex-1 text-right black--text">{{ numberFormat(totalSaleOrder) }}</h3>
            </v-card>
          </v-col>
