                    ...
                    dataSource: new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                ...
                                url: productVariantHandler.itemSearchURL('?plId=' + this.itemModifier.priceLevel.id),
                            },
                            dataType: "json",
                        },
                        schema: {
            ...
            kendo
                ...
                .kendoDropDownList({
                    ...
                    dataSource: new kendo.data.DataSource({
                        serverFiltering: true,
                        transport: {
                            read: {url: uomPriceHandler.uomPriceByPriceLevelURL("id=" + options.model.item.id + "&plId=" + this.itemModifier.priceLevel.id + "&date=" + this.itemModifier.transactionDate + '&nature=purchase'),},
                            dataType: "json",
                        },
                        schema: {
                            model: {
