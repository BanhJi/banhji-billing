        ...
        <v-col sm="12" cols="12" class="grayBg px-6">
            <v-card color="white" class="pa-3 no_border" elevation="0">
                ...
                <v-row class="">
                    ...
                    <v-col sm="1" cols="1" class="pb-0 pt-1" @click="searchTransaction">
                ...
                <v-row>
                    <v-col sm="12" cols="12" class="py-0">
                        <kendo-datasource ref="otherChargeItemDS"
                                          :group="group"
                                          :data="otherChargeTxn"/>
                        <kendo-grid id="gridOtherChargeItemReport" class="grid-function"
