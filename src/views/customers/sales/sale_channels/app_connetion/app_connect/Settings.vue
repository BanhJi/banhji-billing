                ...
                <v-row style="background-color: #fff">
                    ...
                    <v-col sm="12" cols="12" class="pt-0 pb-0 px-4">
                        ...
                        <kendo-grid
                            ...
                            :scrollable-virtual="true">
                            <kendo-grid-column
                                :command="{ iconClass: 'k-icon k-i-trash', text: ' ', click: removeRowLocation, className: 'btn-plus isEditable', }"
                                :title="''"
                                :width="35"
                                :headerAttributes="{ style: 'text-align: left; background-color: #EDF1F5', }"
                            />
...
export default {
    ...
    methods: {
        saveClose() {
            ...
            data.itemLinesLocation = dsLocation.data();
            window.console.log('location', this.locations);
        ...
        addRow2() {
            ...
            this.itemLineLocation.id = uuid.v1();
        ...
        LocationTemplatePartner(dataItem) {
            ...
            if (item) {
                return `<span>${item.name_en ? item.name+'-'+item.name_en : ``}</span>`;
            } else {
                return ``;
            }
        },
            ...
            kendo
                ...
                .kendoDropDownList({
                    ...
                    dataSource: new kendo.data.DataSource({
                        serverFiltering: true,
                        transport: {
                            read: {url: uomPriceHandler.uomPriceByPriceLevelURL("id=" + options.model.item.id + "&plId=" + this.priceLevel.id + "&date=" + this.transactionDate + '&nature=purchase'),},
                            dataType: "json",
                        },
                        schema: {
                            model: {
