                                                ...
                                                <v-row class="mr-0">
                                                    <v-col class="pb-0 pt-0" sm="6" cols="12">
                                                        ...
                                                        <v-select
                                                            ...
                                                            outlined/>
                                                        <div
                                                            v-if="appType === 'npo' || appType  ===  'Public Sectors' ">
                            ...
                            .then((res) => {
                                ...
                                if (res.data.statusCode === 200) {
                                    ...
                                    if (this.segments.length > 0) {
                                        this.saleOrder.segment = this.segments[0];
                                    }
                                } else {
                                    this.showLoading = false
                                }
            ...
            new Promise((resolve) => {
                setTimeout(() => {
                    ...
                    let itmLines = itemLineDS.data().filter(m => m.amount > 0).map(m => {
                        const otherCharge = new OtherChargeModel(m.otherChargeItem || {})
                        m['otherChargeItem'] = otherCharge
