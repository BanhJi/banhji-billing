    ...
    <v-card color="white" class="pl-2 no_border" elevation="0">
        ...
        <v-row class="mt-0">
            ...
            <v-col sm="4" cols="12" class="py-0 pt-6">
                ...
                <app-reporting-language :initLanguage="reportingLanguage" @emitLanguage="reportingLanguage = $event" @onChanged="onReportingLanguageChanges" />
            </v-col>
                ...
                for (let i = 0; i < this.segmentIds.length; i++) {
                    this.statements[i].forEach(value => {
                        if(g[value.account_uuid]){
                            g[value.account_uuid]["s"+i] += kendo.parseFloat(value.balance);
                        }
