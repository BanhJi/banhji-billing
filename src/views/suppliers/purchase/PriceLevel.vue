<template>
  <v-row>
    <v-col sm="12" cols="12" class="py-0 px-4">
            ...
            <v-card-text class="modal_text_content">
              <v-form ref="form" v-model="valid" lazy-validation>
                <v-row>
                  ...
                  <!--                  <v-col sm="12" cols="12" class="py-0 d-flex hidden">-->
          ...
          <v-col sm="12" cols="12" class="pb-0">
            <template>
              ...
              <kendo-grid id="gridPriceLevel" class="grid-function"
                ...
                <!--                    :editable="()=>{ return false}"-->
                <!--                    :attributes="{style: 'text-align: center'}"-->
                <!--                    :command="[{iconClass: 'k-icon k-i-edit', text: 'Variant', click: onVariantSetPrice }]"-->
                <!--                    :headerAttributes="{ style: 'background-color: #EDF1F5' }"/>-->
                <!--                <kendo-grid-column-->
                <!--                    :field="''"-->
                <!--                    :title="$t('')"-->
                ...
                <!--                    :editable="()=>{ return false}"-->
                <!--                    :attributes="{style: 'text-align: center;'}"-->
                <!--                    :command="[{iconClass: 'k-icon k-i-edit', text: 'Service', click: onServiceSetPrice }]"-->
                <!--                    :headerAttributes="{ style: 'background-color: #EDF1F5' }"/>-->
              </kendo-grid>
            </template>
          </v-col>
