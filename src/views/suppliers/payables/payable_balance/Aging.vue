    ...
    <v-col sm="12" cols="12" class="grayBg px-6">
      <v-card color="white" class="pa-3 no_border" elevation="0">
        <v-row>
          ...
          <v-col sm="4" cols="12" class="pb-0 kendo_dropdown_custom py-0">
            <app-datepicker :initialDate="asOf" @emitDate="asOf = $event" />
          </v-col>
          <v-col sm="4" cols="12" class="pb-0 kendo_dropdown_custom py-1">
            <dropdownlist
          ...
          <v-col sm="12" cols="12" class="py-0">
            <template>
              <LoadingMe
                ...
                :myLoading="true"
              />
              <kendo-datasource ref="dataSource" :data="payableAgingList" />
              <kendo-grid
                id="gridPayableAging"
                class="grid-function"
              ...
              >
                ...
                <kendo-grid-column
                  ...
                  :title="$t('current')"
                  :template="
                    '<span>#= kendo.toString(_current, decimalFormat)#</span>'
                  "
                  :width="150"
                ...
                <kendo-grid-column
                  ...
                  :title="$t('1_30')"
                  :template="
                    '<span>#= kendo.toString(_1_30, decimalFormat)#</span>'
                  "
                  :width="150"
                  :attributes="{ style: 'text-align: right; ' }"
                  :headerAttributes="{
                ...
                <kendo-grid-column
                  ...
                  :title="$t('31_60')"
                  :template="
                    '<span>#= kendo.toString(_31_60, decimalFormat)#</span>'
                  "
                  :width="150"
                  :attributes="{ style: 'text-align: right; ' }"
                  :headerAttributes="{
                ...
                <kendo-grid-column
                  ...
                  :title="$t('61_90')"
                  :template="
                    '<span>#= kendo.toString(_61_90, decimalFormat)#</span>'
                  "
                  :width="150"
                  :attributes="{ style: 'text-align: right; ' }"
                  :headerAttributes="{
                ...
                <kendo-grid-column
                  ...
                  :title="$t('>_90')"
                  :template="
                    '<span>#= kendo.toString(_90, decimalFormat)#</span>'
                  "
                  :width="150"
                  :attributes="{ style: 'text-align: right; ' }"
                  :headerAttributes="{
                ...
                <kendo-grid-column
                  ...
                  :title="$t('total')"
                  :template="
                    '<span>#= kendo.toString(total, decimalFormat)#</span>'
                  "
                  :width="150"
                  :attributes="{ style: 'text-align: right; ' }"
                  :headerAttributes="{
                ...
                <kendo-grid-column
                  ...
                  :title="$t('%')"
                  :template="
                    '<span>#= kendo.toString(percentOfPUEX, decimalFormat)# %</span>'
                  "
                  :width="100"
                  :attributes="{ style: 'text-align: right; ' }"
                  :headerAttributes="{
