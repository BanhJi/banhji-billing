                                    ...
                                    <LoadingMe
                                        ...
                                        <v-row class="pt-5"  v-if="!bankClick && !connectBankSuccess">
                                            <v-col sm="6" cols="12" class="pb-0">
                                                <h3 class="primary--text">{{$t('connect_to_partner_financial')}}</h3>
                                                <p class="my-2 dark--text">{{$t('connect_to_partner_financial_desc')}}</p>
                                                <v-row>
                                                    <v-col sm="4" cols="12">
                                                        <v-img width="100%" src="@/assets/images/001.png"/>
                                                        <p class="text-products">{{$t('payment_with_mobile_money_agents')}}</p>
                                                    </v-col>
                                                    <v-col sm="4" cols="12">
                                                        <v-img width="100%" src="@/assets/images/002.png"/>
                                                        <p class="text-products">{{$t('online_payments')}}</p>
                                                    </v-col>
                                                    <v-col sm="4" cols="12">
                                                        <v-img width="100%" src="@/assets/images/003.png"/>
                                                        <p class="text-products">{{$t('proximity_payment')}}</p>
                                                    </v-col>
                                                </v-row>
                                            </v-col>
